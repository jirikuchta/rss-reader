...
class Item {
    ...
    build() {
        ...
        let body = node$4("div", { className: "body" }, "", node);
        ...
        let text = node$4("div", { className: "text" }, "", body);
        text.appendChild(node$4("h3", {}, this.data.title));
        text.appendChild(node$4("p", {}, this.data.summary));
        if (this.data.image_url) {
            let picture = node$4("div", { className: "picture" }, "", body);
            picture.appendChild(node$4("img", { src: this.data.image_url }));
        }
        return node;
    }
}
...
async function build() {
    ...
    if (article.content) {
        ...
        article.image_url && node$4("img", { src: article.image_url }, "", content);
        article.summary && node$4("p", {}, article.summary, content);
    }
